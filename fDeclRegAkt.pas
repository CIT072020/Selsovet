...
type
  TfmDeclRegAkt = class(TfmSimpleD)
    pn: TPanel;
    Label7: TLabel;
    Label8: TLabel;
    edNomer: TDBEditEh;
...
//    function GetNameReport : String; override;
  ...
  function EditDeclRegRogd(nID : Integer) : Boolean;
...
var
  fmDeclRegAkt: TfmDeclRegAkt;

function EditDeclRegRogd(nID : Integer) : Boolean;
begin
//  result := true;
  fmDeclRegAkt := TfmDeclRegAkt.Create(nil);

  try
    with fmDeclRegAkt do begin
      IsReadDokument:=true;
      if nID=-1 then begin
        NewDok(true);
        SetIDZags;
...
constructor TfmDeclRegAkt.Create(Owner: TComponent);
var
  n:Integer;
begin
  inherited;
 // FDokZAGS := true;
  TypeObj := dmBase.TypeObj_UZRogd;
  FAutoNum:=true;
...
destructor TfmDeclRegAkt.Destroy;
begin
  DestroyHint(H);
  inherited;
end;

procedure TfmDeclRegAkt.SetIDZags;
begin
...
function TfmDeclRegAkt.GetVid: String;
begin
  Result := 'DeclRegRogd';
end;

function TfmDeclRegAkt.NewDok( lAppend : Boolean ): Boolean;
begin
  Dokument.EmptyTable;
  Dokument.Append;
...
function TfmDeclRegAkt.ReadDok(nID: Integer): Boolean;
var
  i : Integer;
  fld : TField;
  strField : String;
...
//------------------------------------------------------------------------
procedure TfmDeclRegAkt.WriteSoato(fld:TField);
var
  SOATO:TSOATO;
begin
...
//------------------------------------------------------------------------
function TfmDeclRegAkt.WriteDok: Boolean;
var
  i, nID : Integer;
  fld : TField;
...
procedure TfmDeclRegAkt.UpdateActions;
begin
  inherited;
end;

procedure TfmDeclRegAkt.dsDokumentDataChange(Sender: TObject;  Field: TField);
var
  strField : String;
begin
  inherited;
...
function TfmDeclRegAkt.BeforeEdit: Boolean;
begin
  Result := inherited BeforeEdit;
end;

procedure TfmDeclRegAkt.LoadFromIni;
begin
  inherited;
//  GlobalTask.SetMRUListForm(self);
end;

function TfmDeclRegAkt.SaveToIni: Boolean;
begin
...
procedure TfmDeclRegAkt.OnDestroyHint(Sender: TObject);
begin
  DestroyHint(H);
end;

procedure TfmDeclRegAkt.AdditiveNewDok;
begin
  inherited AdditiveNewDok;
end;

procedure TfmDeclRegAkt.AdditiveReadDok;
begin
  inherited;
end;

procedure TfmDeclRegAkt.CheckOnlyGod;
begin
end;

procedure TfmDeclRegAkt.CheckOnlyGodR;
begin
...
procedure TfmDeclRegAkt.edRNGORODNotInList(Sender: TObject; NewText: String; var RecheckInList: Boolean);
begin
  CheckListRnGor(Sender,NewText,RecheckInList);
end;

procedure TfmDeclRegAkt.CheckRnGorod;
//var
...
procedure TfmDeclRegAkt.edDateRUpdateData(Sender: TObject; var Handled: Boolean);
begin
//  CheckValueDateZAGS(TDbDateTimeEditEh(Sender).Value,TDbDateTimeEditEh(Sender), 1);
end;

function TfmDeclRegAkt.CreateSubMenuRun: Boolean;
//var
// it : TTbItem;
...
procedure TfmDeclRegAkt.pcRastChange(Sender: TObject);
begin
end;

//-----------------------------------------------------------------------------------------
procedure TfmDeclRegAkt.N_F_cbBrakClick(Sender: TObject);
begin
end;

//-----------------------------------------------------------------------------------------
procedure TfmDeclRegAkt.edLicoEnter(Sender: TObject);
begin
end;

//-----------------------------------------------------------------------------------------
procedure TfmDeclRegAkt.FormCreate(Sender: TObject);
begin
  inherited;
  {$IFDEF USE_FR3}
...
//-----------------------------------------------------------------------------------------
procedure TfmDeclRegAkt.dsRastDataChange(Sender: TObject; Field: TField);
begin
...
//-----------------------------------------------------------------------------------------
procedure TfmDeclRegAkt.edRukovEditButtons0Click(Sender: TObject; var Handled: Boolean);
begin
//  ChoiceSpecD(edRukov);
end;

//-----------------------------------------------------------------------------------------
procedure TfmDeclRegAkt.edDokumentEditButtons0Click(Sender: TObject;  var Handled: Boolean);
var
 p : TPassport;
 s : String;
begin
...
procedure TfmDeclRegAkt.edDokumentEditButtons1Click(Sender: TObject; var Handled: Boolean);
begin
  EditDataSet(Dokument);
