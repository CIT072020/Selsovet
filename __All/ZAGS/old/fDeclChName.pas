...
uses
  ...
  fSimpleD, Db, kbmMemTable, ComCtrls, TB2Item, TB2Dock, TB2Toolbar,uSaveMemTable, uProject,uTypes,
...
//  Dokument.Active:=true;
  ...
  d2xml.SetWriteFields('SPEC_D;ADD_SUD;ADD_CHNAME;ADD_DOK;ADD_SUD2');
