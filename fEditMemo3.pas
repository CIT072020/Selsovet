...
uses
  ...
  StdCtrls, Buttons, ExtCtrls, db, FuncPr, uProject;
...
//  function EditMemoHS(ds : TDataSet; strFieldName : String; strCaption : String; HostControl:TControl=nil; nWidth:Integer=0) : Boolean; overload;
  function EditMemo3(var strMemo : String; strCaption : String; HostControl:TControl=nil; nWidth:Integer=0) : Boolean; overload;
