...
type
  TfmDeclRegRogd = class(TfmSimpleD)
    pn: TPanel;
    Label7: TLabel;
    Label8: TLabel;
    edNomer: TDBEditEh;
...
//    function GetNameReport : String; override;
  ...
  function EditDeclRegRogd(nID : Integer; nTypeObj:Integer=0) : Boolean;
...
var
  fmDeclRegRogd: TfmDeclRegRogd;

function EditDeclRegRogd(nID : Integer; nTypeObj:Integer) : Boolean;
begin
//  result := true;
  fmDeclRegRogd := TfmDeclRegRogd.Create(nil);

  if nTypeObj=0
    then nTypeObj:=_TypeObj_UZRogd;
  fmDeclRegRogd.TypeObj:=nTypeObj;

  if nTypeObj=_TypeObj_UZSmert then begin
    fmDeclRegRogd.Caption:='Заявление о регистрации смерти';
  end;

  try
    with fmDeclRegRogd do begin
      IsReadDokument:=true;
      if nID=-1 then begin
        NewDok(true);
        SetIDZags;
...
constructor TfmDeclRegRogd.Create(Owner: TComponent);
var
  n:Integer;
begin
  inherited;
...
destructor TfmDeclRegRogd.Destroy;
begin
  DestroyHint(H);
  inherited;
end;

procedure TfmDeclRegRogd.SetIDZags;
begin
...
function TfmDeclRegRogd.GetVid: String;
begin
  Result := 'DeclRegRogd';
end;

function TfmDeclRegRogd.NewDok( lAppend : Boolean ): Boolean;
begin
  Dokument.EmptyTable;
  Dokument.Append;
...
function TfmDeclRegRogd.ReadDok(nID: Integer): Boolean;
var
  i : Integer;
  fld : TField;
  strField : String;
...
//------------------------------------------------------------------------
procedure TfmDeclRegRogd.WriteSoato(fld:TField);
var
  SOATO:TSOATO;
begin
...
//------------------------------------------------------------------------
function TfmDeclRegRogd.WriteDok: Boolean;
var
  i, nID : Integer;
  fld : TField;
...
procedure TfmDeclRegRogd.UpdateActions;
begin
  inherited;
end;

procedure TfmDeclRegRogd.dsDokumentDataChange(Sender: TObject;  Field: TField);
var
  strField : String;
begin
  inherited;
...
function TfmDeclRegRogd.BeforeEdit: Boolean;
begin
  Result := inherited BeforeEdit;
end;

procedure TfmDeclRegRogd.LoadFromIni;
begin
  inherited;
//  GlobalTask.SetMRUListForm(self);
end;

function TfmDeclRegRogd.SaveToIni: Boolean;
begin
...
procedure TfmDeclRegRogd.OnDestroyHint(Sender: TObject);
begin
  DestroyHint(H);
end;

procedure TfmDeclRegRogd.AdditiveNewDok;
begin
  inherited AdditiveNewDok;
end;

procedure TfmDeclRegRogd.AdditiveReadDok;
begin
  inherited;
end;

procedure TfmDeclRegRogd.CheckOnlyGod;
begin
end;

procedure TfmDeclRegRogd.CheckOnlyGodR;
begin
...
procedure TfmDeclRegRogd.edRNGORODNotInList(Sender: TObject; NewText: String; var RecheckInList: Boolean);
begin
  CheckListRnGor(Sender,NewText,RecheckInList);
end;

procedure TfmDeclRegRogd.CheckRnGorod;
//var
...
procedure TfmDeclRegRogd.edDateRUpdateData(Sender: TObject; var Handled: Boolean);
begin
//  CheckValueDateZAGS(TDbDateTimeEditEh(Sender).Value,TDbDateTimeEditEh(Sender), 1);
end;

function TfmDeclRegRogd.CreateSubMenuRun: Boolean;
//var
// it : TTbItem;
...
procedure TfmDeclRegRogd.pcRastChange(Sender: TObject);
begin
end;

//-----------------------------------------------------------------------------------------
procedure TfmDeclRegRogd.N_F_cbBrakClick(Sender: TObject);
begin
end;

//-----------------------------------------------------------------------------------------
procedure TfmDeclRegRogd.edLicoEnter(Sender: TObject);
begin
end;

//-----------------------------------------------------------------------------------------
procedure TfmDeclRegRogd.FormCreate(Sender: TObject);
begin
  inherited;
  {$IFDEF USE_FR3}
...
//-----------------------------------------------------------------------------------------
procedure TfmDeclRegRogd.dsRastDataChange(Sender: TObject; Field: TField);
begin
...
//-----------------------------------------------------------------------------------------
procedure TfmDeclRegRogd.edRukovEditButtons0Click(Sender: TObject; var Handled: Boolean);
begin
//  ChoiceSpecD(edRukov);
end;

//-----------------------------------------------------------------------------------------
procedure TfmDeclRegRogd.edDokumentEditButtons0Click(Sender: TObject;  var Handled: Boolean);
var
 p : TPassport;
 s : String;
begin
...
procedure TfmDeclRegRogd.edDokumentEditButtons1Click(Sender: TObject; var Handled: Boolean);
begin
  EditDataSet(Dokument);
