object fmSelDoc2: TfmSelDoc2
  Left = 48
  Top = 116
  ActiveControl = dgSelDoc
  AutoScroll = False
  Caption = #1042#1099#1073#1088#1072#1090#1100' '#1079#1072#1088#1077#1075#1080#1089#1090#1088#1080#1088#1086#1074#1072#1085#1085#1099#1077' '#1079#1072#1103#1074#1083#1077#1085#1080#1103
  ClientHeight = 352
  ClientWidth = 729
  Color = clBtnFace
  ...
  object gbFilter: TGroupBox
    ...
    Width = 712
    Height = 111
    Caption = ' '#1055#1086#1082#1072#1079#1099#1074#1072#1090#1100' '#1079#1072#1103#1074#1083#1077#1085#1080#1103': '
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'Tahoma'
    ...
    object chbShowAllAdmProc: TCheckBox
      Left = 542
      Top = 52
      Width = 132
      Height = 17
      Caption = #1087#1086' '#1074#1089#1077#1084' '#1087#1088#1086#1094#1077#1076#1091#1088#1072#1084
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
