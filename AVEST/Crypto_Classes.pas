...
function TCryptMain.DecryptDocFromStream(const ADocAsStream: TStream; const AOutStream: TMemoryStream; out ErrMessage: string; const RaiseIfError: Boolean = True): Boolean;
var
  OutBuffer: Pointer;
...
begin
  ...
  try
    ...
    CheckMsg(AvCmDecrypt(FHc, AOutStream.Memory, AOutStream.Size, @OutBuffer, OutBufferSize, AVCMF_IN_RAW_DATA or AVCMF_ALLOC));
    try
      AOutStream.Position := soFromBeginning;
...
function TCryptMain.DeleteSignInfo(const AXMLDoc: IXMLDOMDocument2;  const ASignInfoNodePath: string): IXMLDOMDocument2;
var
  OldNode: IXMLDOMNode;
begin
