...
type
  ...
  pension2             = class;                 { "http://gisun.agatsystem.by/common/types/"[Alias] }
  ...
  private
    ...
    Fsuspension_date: TXSDate;
    Fsuspension_date_Specified: boolean;
    Factive: Boolean;
    Factive_Specified: boolean;
    procedure Setaccess(Index: Integer; const AClassifier: Classifier);
    function  access_Specified(Index: Integer): boolean;
    ...
    procedure Setsuspension_date(Index: Integer; const ATXSDate: TXSDate);
    function  suspension_date_Specified(Index: Integer): boolean;
    procedure Setactive(Index: Integer; const ABoolean: Boolean);
    function  active_Specified(Index: Integer): boolean;
  public
    destructor Destroy; override;
  published
    ...
    property suspension_date:       TXSDate     Index (IS_OPTN) read Fsuspension_date write Setsuspension_date stored suspension_date_Specified;
    property active:                Boolean     Index (IS_OPTN) read Factive write Setactive stored active_Specified;
  end;
  ...
  // Namespace : http://gisun.agatsystem.by/common/types/
  // ************************************************************************ //
  pension2 = class(Pension)
  private
  published
  end;

  PensionList = array of pension2;              { "http://gisun.agatsystem.by/common/types/"[GblCplx] }
  ...
  private
    ...
    procedure Setpensions(Index: Integer; const APensionList: PensionList);
  ...
  published
    ...
    property pensions:       PensionList      Index (IS_OPTN) read Fpensions write Setpensions stored pensions_Specified;
  end;
...
procedure PersonalData.Setpensions(Index: Integer; const APensionList: PensionList);
begin
  Fpensions := APensionList;
...
procedure Pension.Setsuspension_date(Index: Integer; const ATXSDate: TXSDate);
begin
  Fsuspension_date := ATXSDate;
  Fsuspension_date_Specified := True;
end;

function Pension.suspension_date_Specified(Index: Integer): boolean;
begin
  Result := Fsuspension_date_Specified;
end;

procedure Pension.Setactive(Index: Integer; const ABoolean: Boolean);
begin
  Factive := ABoolean;
  Factive_Specified := True;
end;

function Pension.active_Specified(Index: Integer): boolean;
begin
  Result := Factive_Specified;
end;
...
initialization
  ...
  InvRegistry.RegisterAllSOAPActions(TypeInfo(GisunCommonWs), '|urn:getPersonalData||urn:getPersonIdentif');
  ...
  RemClassRegistry.RegisterXSClass(pension2, 'http://gisun.agatsystem.by/common/types/', 'pension2', 'pension');
  RemClassRegistry.RegisterXSInfo(TypeInfo(PensionList), 'http://gisun.agatsystem.by/common/types/', 'PensionList');
