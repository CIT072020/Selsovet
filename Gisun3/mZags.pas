...
interface
uses
   wsGisun, wsZags, SysUtils, Classes, Forms, TypInfo, SoapHTTPClient, WinInet, SOAPHTTPTrans, uProject, XSBuiltIns,
...
type
   ...
   public
      ...
      //вызов методов
      //для вызова этого метода надо использовать отдельный сервис
      ...
      function PostBirthCertificate(const birthActRequest: birth_act; Log: TStrings; User, Pasw: string): return_code;
      //установление отцовства
      function PostAffiliationCertificate(const affActRequest: affiliation_act; Log: TStrings; User, Pasw: string): return_code;
      // восстановление актовой записи о рождении
      function PostReconstBirthCertificate(const rcnBirthActRequest: reconstructed_birth_act; Log: TStrings; User, Pasw: string): return_code;
      //регистрация брака
      function PostMarriageCertificate(const mrgActRequest: marriage_act; Log: TStrings; User, Pasw: string): return_code;
      //расторжение брака
      function PostDivorceCertificate(const dvcActRequest: divorce_act; Log: TStrings; User, Pasw: string): return_code;
      //усыновление
      function PostAdoptionCertificate(const adpActRequest: adoption_act; Log: TStrings; User, Pasw: string): return_code;
      //умирание
      function PostDeceaseCertificate(const dcsActRequest: decease_act; Log: TStrings; User, Pasw: string): return_code;
      //перемена имени
      function PostNameChangeCertificate(const cngActRequest: name_change_act; Log: TStrings; User, Pasw: string): return_code;
...
function TZagsInterface.GetPersonalData(const registerRequest: register_request; var registerResponse: register_response; Log: TStrings; User, Pasw: string): Boolean;
var
   hdr: TSOAPHeader;
...
begin
   ...
   try
      if GetService<>nil then begin
         hdr:=nil;
         if IsCreateHeader then begin // (User<>'') and (Pasw<>'') then begin
...
function TZagsInterface.PostBirthCertificate(const birthActRequest: birth_act; Log: TStrings; User, Pasw: string): return_code;
var
   hdr: TSOAPHeader;
   Headers: ISOAPHeaders;
begin
...
function TZagsInterface.PostAdoptionCertificate(const adpActRequest: adoption_act; Log: TStrings; User, Pasw: string): return_code;
var
   hdr: TSOAPHeader;
   Headers: ISOAPHeaders;
begin
...
function TZagsInterface.PostAffiliationCertificate(const affActRequest: affiliation_act; Log: TStrings; User, Pasw: string): return_code;
var
   hdr: TSOAPHeader;
   Headers: ISOAPHeaders;
begin
...
function TZagsInterface.PostDeceaseCertificate(const dcsActRequest: decease_act; Log: TStrings; User, Pasw: string): return_code;
var
   hdr: TSOAPHeader;
   Headers: ISOAPHeaders;
begin
...
function TZagsInterface.PostDivorceCertificate(const dvcActRequest: divorce_act; Log: TStrings; User, Pasw: string): return_code;
var
   hdr: TSOAPHeader;
   Headers: ISOAPHeaders;
begin
...
function TZagsInterface.PostMarriageCertificate(const mrgActRequest: marriage_act; Log: TStrings; User, Pasw: string): return_code;
var
   hdr: TSOAPHeader;
   Headers: ISOAPHeaders;
begin
...
function TZagsInterface.PostNameChangeCertificate(const cngActRequest: name_change_act; Log: TStrings; User, Pasw: string): return_code;
var
   hdr: TSOAPHeader;
   Headers: ISOAPHeaders;
begin
...
function TZagsInterface.PostReconstBirthCertificate(const rcnBirthActRequest: reconstructed_birth_act; Log: TStrings; User, Pasw: string): return_code;
var
   hdr: TSOAPHeader;
   Headers: ISOAPHeaders;
begin
