...
// WSDL     : http://todes.by:8888/gisun-inf/zags/ws?wsdl
//  >Import : http://todes.by:8888/gisun-inf/zags/ws?wsdl:0
//  >Import : http://todes.by:8888/gisun-inf/zags/ws?xsd=1
//  >Import : http://todes.by:8888/gisun-inf/zags/ws?xsd=3
//  >Import : http://todes.by:8888/gisun-inf/zags/ws?xsd=2
//  >Import : http://todes.by:8888/gisun-inf/zags/ws?wsdl:1
//  >Import : http://todes.by:8888/gisun-inf/zags/ws?wsdl:2
// Encoding : UTF-8
// Version  : 1.0
// (01.12.2015 10:53:55 - - $Rev: 10138 $)
// ************************************************************************ //
...
type
  ...
  MarrFlag = (adoptiveParentsMarr, parentAndAdoptiveMarr);
  ...
  // service   : ws
  // port      : ws
  // URL       : http://todes.by:8888/gisun-inf/zags/ws
  // ************************************************************************ //
  ZagsWsImpl = interface(IInvokable)
  ['{663DE6B5-B664-7C57-3E7F-98699C6E0D1C}']
...
function GetZagsWsImpl(UseWSDL: Boolean=System.False; Addr: string=''; HTTPRIO: THTTPRIO = nil): ZagsWsImpl;


implementation
  uses SysUtils;

function GetZagsWsImpl(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): ZagsWsImpl;
const
  defWSDL = 'http://todes.by:8888/gisun-inf/zags/ws?wsdl';
  defURL  = 'http://todes.by:8888/gisun-inf/zags/ws';
  defSvc  = 'ws';
  defPrt  = 'ws';
var
  RIO: THTTPRIO;
...
initialization
  InvRegistry.RegisterInterface(TypeInfo(ZagsWsImpl), 'http://gisun.agatsystem.by/zags/ws/', 'UTF-8');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(ZagsWsImpl), 'urn:%operationName%');
  InvRegistry.RegisterInvokeOptions(TypeInfo(ZagsWsImpl), ioDocument);
  InvRegistry.RegisterInvokeOptions(TypeInfo(ZagsWsImpl), ioLiteral);
