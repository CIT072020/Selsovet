...
// WSDL     : http://todes.by:8888/gisun-inf/common/ws?wsdl
//  >Import : http://todes.by:8888/gisun-inf/common/ws?wsdl:0
//  >Import : http://todes.by:8888/gisun-inf/common/ws?xsd=1
//  >Import : http://todes.by:8888/gisun-inf/common/ws?xsd=2
//  >Import : http://todes.by:8888/gisun-inf/common/ws?wsdl:1
// Encoding : UTF-8
// Version  : 1.0
// (01.12.2015 11:00:31 - - $Rev: 10138 $)
// ************************************************************************ //
...
type
  ...
  private
    ...
    Ftemp_address: Address;
    Ftemp_address_Specified: boolean;
    Fdeaths: deaths;
    ...
    procedure Settemp_address(Index: Integer; const AAddress: Address);
    function  temp_address_Specified(Index: Integer): boolean;
  ...
  published
    ...
    property temp_address:     Address               Index (IS_OPTN) read Ftemp_address write Settemp_address stored temp_address_Specified;
  ...
  Array_Of_CourtDeathData = array of CourtDeathData;   { "http://gisun.agatsystem.by/common/types/"[GblUbnd] }
  Array_Of_CourtAbsentData = array of CourtAbsentData;   { "http://gisun.agatsystem.by/common/types/"[GblUbnd] }
  Array_Of_CourtUnefficientData = array of CourtUnefficientData;   { "http://gisun.agatsystem.by/common/types/"[GblUbnd] }
  Array_Of_CourtRestrictEfficientData = array of CourtRestrictEfficientData;   { "http://gisun.agatsystem.by/common/types/"[GblUbnd] }
  ...
  private
    FdeathData: Array_Of_CourtDeathData;
    FabsentData: Array_Of_CourtAbsentData;
    FunefficientData: Array_Of_CourtUnefficientData;
    FrestrictefficientData: Array_Of_CourtRestrictEfficientData;
  public
    destructor Destroy; override;
  published
    property deathData:             Array_Of_CourtDeathData              Index (IS_UNBD) read FdeathData write FdeathData;
    property absentData:            Array_Of_CourtAbsentData             Index (IS_UNBD) read FabsentData write FabsentData;
    property unefficientData:       Array_Of_CourtUnefficientData        Index (IS_UNBD) read FunefficientData write FunefficientData;
    property restrictefficientData: Array_Of_CourtRestrictEfficientData  Index (IS_UNBD) read FrestrictefficientData write FrestrictefficientData;
  end;
  ...
  // ************************************************************************ //
  // Namespace : http://gisun.agatsystem.by/common/ws/
  // soapAction: ||urn:getPersonalData|urn:getPersonIdentif|urn:getPersonList
  // transport : http://schemas.xmlsoap.org/soap/http
  // style     : document
  // binding   : wsBinding
  // service   : ws
  // port      : ws
  // URL       : http://todes.by:8888/gisun-inf/common/ws
  // ************************************************************************ //
  GisunCommonWsImpl = interface(IInvokable)
...
function GetGisunCommonWsImpl(UseWSDL: Boolean=System.False; Addr: string=''; HTTPRIO: THTTPRIO = nil): GisunCommonWsImpl;


implementation
  uses SysUtils;

function GetGisunCommonWsImpl(UseWSDL: Boolean; Addr: string; HTTPRIO: THTTPRIO): GisunCommonWsImpl;
const
  defWSDL = 'http://todes.by:8888/gisun-inf/common/ws?wsdl';
  defURL  = 'http://todes.by:8888/gisun-inf/common/ws';
  defSvc  = 'ws';
  defPrt  = 'ws';
var
  RIO: THTTPRIO;
begin
  ...
  if HTTPRIO = nil then
    ...
    RIO := HTTPRIO;
  try
    Result := (RIO as GisunCommonWsImpl);
    if UseWSDL then
    begin
...
procedure deathInfo.Setdocuments(Index: Integer; const Adocuments: documents);
begin
...
procedure photoInfo.Setdocuments(Index: Integer; const Adocuments2: documents2);
begin
...
procedure familyInfo.Setdocuments(Index: Integer; const Adocuments3: documents3);
begin
...
procedure martialStatusInfo.Setdocuments(Index: Integer; const Adocuments4: documents4);
begin
...
procedure educationInfo.Setdocuments(Index: Integer; const Adocuments5: documents5);
begin
...
procedure scienceRankInfo.Setdocuments(Index: Integer; const Adocuments6: documents6);
begin
...
procedure scienceDegreeInfo.Setdocuments(Index: Integer; const Adocuments7: documents7);
begin
...
procedure pensionInfo.Setdocuments(Index: Integer; const Adocuments8: documents8);
begin
...
procedure insuranceInfo.Setdocuments(Index: Integer; const Adocuments9: documents9);
begin
...
procedure taxInfo.Setdocuments(Index: Integer; const Adocuments10: documents10);
begin
...
procedure militaryInfo.Setdocuments(Index: Integer; const Adocuments11: documents11);
begin
...
procedure PersonalData.Settemp_address(Index: Integer; const AAddress: Address);
begin
  Ftemp_address := AAddress;
  Ftemp_address_Specified := True;
end;

function PersonalData.temp_address_Specified(Index: Integer): boolean;
begin
  Result := Ftemp_address_Specified;
end;
...
var
  I: Integer;
begin
  for I := 0 to Length(FdeathData)-1 do
    FreeAndNil(FdeathData[I]);
  SetLength(FdeathData, 0);
  for I := 0 to Length(FabsentData)-1 do
    FreeAndNil(FabsentData[I]);
  SetLength(FabsentData, 0);
  for I := 0 to Length(FunefficientData)-1 do
    FreeAndNil(FunefficientData[I]);
  SetLength(FunefficientData, 0);
  for I := 0 to Length(FrestrictefficientData)-1 do
    FreeAndNil(FrestrictefficientData[I]);
  SetLength(FrestrictefficientData, 0);
  inherited Destroy;
end;
...
initialization
  InvRegistry.RegisterInterface(TypeInfo(GisunCommonWsImpl), 'http://gisun.agatsystem.by/common/ws/', 'UTF-8');
  InvRegistry.RegisterAllSOAPActions(TypeInfo(GisunCommonWsImpl), '||urn:getPersonalData|urn:getPersonIdentif|urn:getPersonList');
  InvRegistry.RegisterInvokeOptions(TypeInfo(GisunCommonWsImpl), ioDocument);
  InvRegistry.RegisterInvokeOptions(TypeInfo(GisunCommonWsImpl), ioLiteral);
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(Array_Of_CourtDeathData), 'http://gisun.agatsystem.by/common/types/', 'Array_Of_CourtDeathData');
  RemClassRegistry.RegisterXSInfo(TypeInfo(Array_Of_CourtAbsentData), 'http://gisun.agatsystem.by/common/types/', 'Array_Of_CourtAbsentData');
  RemClassRegistry.RegisterXSInfo(TypeInfo(Array_Of_CourtUnefficientData), 'http://gisun.agatsystem.by/common/types/', 'Array_Of_CourtUnefficientData');
  RemClassRegistry.RegisterXSInfo(TypeInfo(Array_Of_CourtRestrictEfficientData), 'http://gisun.agatsystem.by/common/types/', 'Array_Of_CourtRestrictEfficientData');
