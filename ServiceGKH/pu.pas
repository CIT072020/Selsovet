...
//      writedebug(strSQL);
      ...
      if lDop then begin
        s:='';
        for i:=1 to 14 do s:=s+'\tab';
        PrintString(sl, s+'\ql Приложение 1\line'+s+' к постановлению Центральной комиссии\line'+s+' Республики Беларусь по выборам и\line'+s+' проведению республиканских\line'+s+' референдумов\line'+s+' 06.08.2019 № 30\par ', 0, 12, false, False, False);
      end;
...
//      PrintString(sl, StringOfChar('-',30)+'\par', 0, 10, false, false, false);
      ...
      PrintString(sl, '**	При досрочном голосовании избиратель дополнительно указывает дату голосования.\par', 0, 10, false, false, false);
