...
type
  TfmEditNalog = class(TfmSimpleDialog)
...
procedure TfmEditNalog.UpdateActions;
begin
  inherited;
  btOk.Enabled:=(edTypeDok.ItemIndex>-1) and (edData.Value<>null);
end;

procedure TfmEditNalog.FormCreate(Sender: TObject);
var
 Opis:TOpisEdit;
 i:Integer;
begin          
...
procedure TfmEditNalog.edTypeDokEditButtons0Click(Sender: TObject;  var Handled: Boolean);
var
  Opis:TOpisEdit;
  nKod,n:Integer;
  sSeek:String;
