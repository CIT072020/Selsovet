...
begin
   ...
   ChangeYear;
   ChangeYear2;
//   if (FFilterInterface.SearchDate=FFilterInterface.CurrentSearchDate) then begin
//   end;
...
begin
   ...
   if not FFilterInterface.UseYear then begin
     ...
     if (FFilterInterface.CurrentSearchDate>0) and  (FFilterInterface.CurrentSearchDate=FFilterInterface.SearchDate)
       then gbYear.Enabled:=False;
   end;
