...
type
  ...
  TfrxPreviewForm = class(TForm)
    ...
    procedure btFastPrintClick(Sender: TObject);
  private
...
begin
  ...
  // vadim    !!!
  btFastPrint.ImageIndex:=frxResources.PreviewButtonImages.Count-1;
...
procedure TfrxPreviewForm.btFastPrintClick(Sender: TObject);
begin
...
//d60068572d2d066356d6b9ed66680ed7