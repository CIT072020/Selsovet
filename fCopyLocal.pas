...
//------------------------------------------------------------------------
procedure TfmCopyLocal.btOkClick(Sender: TObject);
begin
  ModalResult := mrOk;
end;
//------------------------------------------------------------------------
procedure TfmCopyLocal.cbArxivClick(Sender: TObject);
begin
  ArxivCopy:=cbArxiv.Checked;
end;
//------------------------------------------------------------------------
function TfmCopyLocal.CopyListFiles(lCheckArxiv:Boolean) : Boolean;
var
  i : Integer;
  FileAttrs : Integer;
...
//------------------------------------------------------------------------
function TfmCopyLocal.OpenTablesDict( strNameDict : String ) : Boolean;
var
...
//-----------------------------------------------------------------
function TfmCopyLocal.GetPropAutoBackup(s:String; var strData:String; var strTime:String):Boolean;
var
  n:Integer;
begin
  Result:=true;
...
function TfmCopyLocal.IsRunAutoBackup(var strFile:String):Boolean;
var
  nTypeBackup:Integer;
...
//-----------------------------------------------------------------
function TfmCopyLocal.CopyData:Boolean;
var
...
//------------------------------------------------------------------------
function TfmCopyLocal.IsDocArxiv : Boolean;
begin
  Result:=cbDocArxiv.Visible and cbDocArxiv.Checked and cbDocArxiv.Enabled;
end;
//------------------------------------------------------------------------
function TfmCopyLocal.CheckCopyDocArxiv : Boolean;
var
  i : Integer;
  strDir : String;
begin
...
//------------------------------------------------------------------------
function TfmCopyLocal.CopyParams(nType:Integer; lRestore:Boolean; var sSoob:String) : Boolean;
var
...
//------------------------------------------------------------------------
function TfmCopyLocal.CheckCopy(var strErr : String): Boolean;
var
  strPathS : String;
  strPathD : String;
  FileAttrs : Integer;
...
//------------------------------------------------------------------------
function TfmCopyLocal.CheckCopyRestore(var strErr : String): Boolean;
var
  strPathS : String;
  strPathD : String;
  FileAttrs,n : Integer;
...
//------------------------------------------------------------------------
procedure TfmCopyLocal.FormCreate(Sender: TObject);
var
  s:String;
begin
  FIdBase:='';
...
//------------------------------------------------------------------------
function TfmCopyLocal.SeekAnyFileDocArxiv(strPath:String):Boolean;
var
  s:String;
  sr:TSearchRec;
  lSeek:Boolean;
...
//------------------------------------------------------------------------
function TfmCopyLocal.ChoiceAutoBackup : Integer;
var
  sl : TStringList;
  s : String;
  n : Integer;
...
//------------------------------------------------------------------------
function TfmCopyLocal.GetPropertyAutoBackup( n : Integer ) : String;
var
...
//------------------------------------------------------------------------
procedure TfmCopyLocal.SetAutoBackup(const Value: Boolean);
begin
  FAutoBackup := Value;
  if Value then begin
    edPath.Text := FPathAutoBackup;
...
//------------------------------------------------------------------------
procedure TfmCopyLocal.FormDestroy(Sender: TObject);
begin
  FListSource.Free;
end;

//------------------------------------------------------------------------
procedure TfmCopyLocal.btCancelClick(Sender: TObject);
begin
  Close;
end;

//------------------------------------------------------------------------
procedure TfmCopyLocal.edPathEditButtons0Click(Sender: TObject; var Handled: Boolean);
var
  strDir, s : String;
begin
...
//------------------------------------------------------------------------
procedure TfmCopyLocal.SetRestore(const Value: Boolean);
begin
  FRestore := Value;
...
//------------------------------------------------------------------------
procedure TfmCopyLocal.UpdateActions;
begin
  inherited;
...
//------------------------------------------------------------------------
procedure TfmCopyLocal.SetNumCopy(const Value: Integer);
begin
  FNumCopy := Value;
end;

//------------------------------------------------------------------------
procedure TfmCopyLocal.DropMessageMouse(var Msg: TMsg;  var Handled: Boolean);
begin
...
//------------------------------------------------------------------------
procedure TfmCopyLocal.SetFullPath(const Value: Boolean);
begin
  FFullPath := Value;
...
procedure TfmCopyLocal.cbRestoreParamsClick(Sender: TObject);
begin
{
  if FRestore then begin
...
//------------------------------------------------------------
procedure TfmCopyLocal.SetIdBase(const Value: String);
begin
  FIdBase := Value;
end;
//------------------------------------------------------------
procedure TfmCopyLocal.SetArxivCopy(const Value: Boolean);
begin
  FArxivCopy := Value;
end;
//------------------------------------------------------------
function TfmCopyLocal.getNameFileArxiv:String;
begin
...
function TfmCopyLocal.RunZipBase(strBaseDir:String; strPath:String):Boolean;
begin
  FError:='';
...
function TfmCopyLocal.RunUnZipBase(strBaseDir:String; strFile:String):Boolean;
begin
  FError:='';
  Result:=true;
  try
...
//----------------------------------------------------------------------------
procedure TfmCopyLocal.Button1Click(Sender: TObject);
begin
