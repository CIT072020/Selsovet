object fmChRR: TfmChRR
  Left = 362
  Top = 242
  BorderStyle = bsDialog
  Caption = #1042#1099#1073#1077#1088#1080#1090#1077' '#1086#1088#1075#1072#1085' '#1047#1040#1043#1057
  ClientHeight = 129
  ClientWidth = 495
  Color = clBtnFace
  ...
  object queryRn: TAdsQuery
    ...
    SQL.Strings = (
      'SELECT *  FROM SprZAGS'
      '  WHERE Substring(soato,1,1)=:PAR_OBL'
      '  ORDER BY soato')
    AdsConnection = dmBase.AdsSharedConnection
    Left = 72
    Top = 82
