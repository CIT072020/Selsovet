inherited fmSMDODoc: TfmSMDODoc
      ...
      object tsDoc: TTabSheet
        ...
        object gbFiles: TGroupBox
          ...
          object Panel2: TPanel
            ...
            object btETSPFileAll: TBitBtn
              Left = 9
              Top = 105
              Width = 28
              Height = 28
              Hint = #1044#1086#1073#1072#1074#1090#1100' '#1069#1062#1055' '#1082#1086' '#1074#1089#1077#1084' '#1092#1072#1081#1083#1072#1084' '#1089#1086#1086#1073#1097#1077#1085#1080#1103
              TabOrder = 3
              OnClick = btETSPFileAllClick
              Glyph.Data = {
                36030000424D3603000000000000360000002800000010000000100000000100
                18000000000000030000000000000000000000000000000000007F7F7F7F7F7F
        ...
        object pnFolder: TPanel
          ...
          object Panel4: TPanel
            ...
            object GroupBox2: TGroupBox
              ...
              Height = 108
              Align = alRight
              Caption = ' '#1057#1089#1099#1083#1082#1072' '#1085#1072' '#1086#1090#1087#1088#1072#1074#1083#1077#1085#1085#1099#1081' '#1076#1086#1082#1091#1084#1077#1085#1090' '
              TabOrder = 1
              DesignSize = (
                268
                108)
  ...
  inherited TBDock: TTBDock
    ...
    inherited TBToolbar: TTBToolbar
      ...
      inherited TBItemHistCorr: TTBItem [21]
      end
  ...
  inherited Dokument: TkbmMemTable
    ...
    object DokumentDOC_STATUS: TSmallintField
  ...
  object pmFiles: TPopupMenu
    ...
    object pmFilesAll_SaveClick: TMenuItem
      Caption = #1057#1086#1093#1088#1072#1085#1080#1090#1100' '#1074#1089#1077' '#1092#1072#1081#1083#1099' '#1074' '#1087#1072#1087#1082#1091
      OnClick = pmFilesAll_SaveClickClick
    end
    object N2: TMenuItem
      Caption = '-'
    end
    ...
    object pmFilesWithETSPAll_Save: TMenuItem
      Caption = #1057#1086#1093#1088#1072#1085#1080#1090#1100' '#1074#1089#1077' '#1092#1072#1081#1083#1099' c '#1069#1062#1055'(p7s) '#1074' '#1087#1072#1087#1082#1091
      Visible = False
    end
    object N1: TMenuItem
      Caption = '-'
    ...
    object pmFiles_ETSP: TMenuItem
      Caption = #1069#1083#1077#1082#1090#1088#1086#1085#1085#1086'-'#1094#1080#1092#1088#1086#1074#1072#1103' '#1087#1086#1076#1087#1080#1089#1100' '#1092#1072#1081#1083#1072
      ImageIndex = 87
      OnClick = pmFiles_ETSPClick
    end
    object pmFilesAll_ETSP: TMenuItem
      Caption = #1044#1086#1073#1072#1074#1090#1100' '#1069#1062#1055' '#1082#1086' '#1074#1089#1077#1084' '#1092#1072#1081#1083#1072#1084' '#1089#1086#1086#1073#1097#1077#1085#1080#1103
      ImageIndex = 160
      OnClick = pmFilesAll_ETSPClick
    end
  end
