...
function TfmRasxodSvid.Date: TDateTime;
begin
  Result := edDate.Value;
end;

procedure TfmRasxodSvid.FormCreate(Sender: TObject);
var
  Opis : TOpisEdit;
  i : Integer;
begin
...
function TfmRasxodSvid.Nomer1: String;
begin
  Result := edNomer1.Text;
end;

function TfmRasxodSvid.Nomer2: String;
begin
  Result := edNomer2.Text;
end;

function TfmRasxodSvid.Seria: String;
begin
  Result := edSeria.Text;
end;

function TfmRasxodSvid.TypeSvid: Integer;
begin
...
procedure TfmRasxodSvid.TBItem2Click(Sender: TObject);
begin
  ModalResult := mrCancel;
end;

procedure TfmRasxodSvid.TBItem1Click(Sender: TObject);
var
  strErr,s1,s2 : String;
  d : TDateTime;
  n1,n2 : Integer;
...
procedure TfmRasxodSvid.edNomer1UpdateData(Sender: TObject;
  var Handled: Boolean);
begin
  edNomer1.Text := PadLStr(Trim(edNomer1.Text),SVID_LEN,'0');
end;

procedure TfmRasxodSvid.edNomer2UpdateData(Sender: TObject;
  var Handled: Boolean);
begin
  edNomer2.Text := PadLStr(Trim(edNomer2.Text),SVID_LEN,'0');
end;
