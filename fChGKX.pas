...
procedure TfmChGKX.SetValueSOATO(const Value: String);
begin
  FValueSOATO := Value;
  if Value <> '' then begin
  {
...
procedure TfmChGKX.FormCreate(Sender: TObject);
begin
  FClearKey := false;
end;

procedure TfmChGKX.edOblChange(Sender: TObject);
var
  cur : TCursor;
  sObl : String;
begin
...
procedure TfmChGKX.edRnChange(Sender: TObject);
var
  cur : TCursor;
begin
 cur := Screen.Cursor;
...
procedure TfmChGKX.btOkClick(Sender: TObject);
begin
...
procedure TfmChGKX.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TfmChGKX.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TfmChGKX.SetIDGES(const Value: String);
var
  strSOATO:String;
  sObl:String;
begin
