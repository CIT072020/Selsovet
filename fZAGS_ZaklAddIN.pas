...
uses
  ...
  OpisEdit, MetaTask, FR_DSet, FR_DBSet, TB2ExtItems, DBCtrls, Grids,uTypes,
...
type
  TfmZAGS_ZaklAddIN = class(TfmSimpleD)
...
//    function GetTypeBrak:Integer;
  ...
  function EditZAGS_ZaklAddIN(nID : Integer) : Boolean;
...
var
  fmZAGS_ZaklAddIN: TfmZAGS_ZaklAddIN;

function EditZAGS_ZaklAddIN(nID : Integer) : Boolean;
begin
//  result := true;
  fmZAGS_ZaklAddIN := TfmZAGS_ZaklAddIN.Create(nil);
  try
    with fmZAGS_ZaklAddIN do begin
      IsReadDokument:=true;
...
//      CheckEnabledNameOrgan(false);
    ...
    fmZAGS_ZaklAddIN.Free;
    fmZAGS_ZaklAddIN:=nil;
  end;
end;

{ TfmZAGS_ZaklAddIN }

constructor TfmZAGS_ZaklAddIN.Create(Owner: TComponent);
var
  n:Integer;
  d2xml:TDataSet2XML;
begin
...
procedure TfmZAGS_ZaklAddIN.SetIDZags;
begin
...
function TfmZAGS_ZaklAddIN.GetVid: String;
begin
  Result := 'ZAGS_ZaklAddIN';
end;

function TfmZAGS_ZaklAddIN.NewDok( lAppend : Boolean ): Boolean;
begin
  Dokument.EmptyTable;
  Dokument.Append;
...
function TfmZAGS_ZaklAddIN.ReadDok(nID: Integer): Boolean;
var
  i : Integer;
  fld : TField;
  strField,s : String;
...
//------------------------------------------------------------------------
procedure TfmZAGS_ZaklAddIN.WriteSoato(fld:TField);
var
  SOATO:TSOATO;
begin
...
//------------------------------------------------------------------------
function TfmZAGS_ZaklAddIN.WriteDok: Boolean;
var
  i, nID : Integer;
  fld : TField;
...
procedure TfmZAGS_ZaklAddIN.UpdateActions;
begin
  inherited;
end;
//-----------------------------------------------------------------------------
procedure TfmZAGS_ZaklAddIN.dsDokumentDataChange(Sender: TObject; Field: TField);
//var
//  strField : String;
begin
  inherited;
...
//-----------------------------------------------------------------------------
function TfmZAGS_ZaklAddIN.BeforeEdit: Boolean;
begin
  Result := inherited BeforeEdit;
end;
//-----------------------------------------------------------------------------
procedure TfmZAGS_ZaklAddIN.LoadFromIni;
begin
  inherited;
//  GlobalTask.SetMRUListForm(self);
end;
//-----------------------------------------------------------------------------
function TfmZAGS_ZaklAddIN.SaveToIni: Boolean;
begin
...
//-----------------------------------------------------------------------------
procedure TfmZAGS_ZaklAddIN.OnDestroyHint(Sender: TObject);
begin
  DestroyHint(H);
end;
//-----------------------------------------------------------------------------
procedure TfmZAGS_ZaklAddIN.AdditiveNewDok;
begin
  inherited AdditiveNewDok;
end;

procedure TfmZAGS_ZaklAddIN.AdditiveReadDok;
begin
  inherited;
end;

procedure TfmZAGS_ZaklAddIN.CheckOnlyGod;
begin
end;

procedure TfmZAGS_ZaklAddIN.CheckOnlyGodR;
begin
...
procedure TfmZAGS_ZaklAddIN.edGT_RNGORODNotInList(Sender: TObject;
  NewText: String; var RecheckInList: Boolean);
begin
  CheckListRnGor(Sender,NewText,RecheckInList);
end;

procedure TfmZAGS_ZaklAddIN.CheckRnGorod;
//var
...
procedure TfmZAGS_ZaklAddIN.cbOnlyGodChange(Sender: TObject);
begin
  CheckOnlyGod;
end;

procedure TfmZAGS_ZaklAddIN.cbOnlyGodRChange(Sender: TObject);
begin
  CheckOnlyGodR;
end;

procedure TfmZAGS_ZaklAddIN.edDateRUpdateData(Sender: TObject; var Handled: Boolean);
begin
  CheckValueDateZAGS(TDbDateTimeEditEh(Sender).Value,TDbDateTimeEditEh(Sender), 1);
end;

function TfmZAGS_ZaklAddIN.CreateSubMenuRun: Boolean;
//var
// it : TTbItem;
...
procedure TfmZAGS_ZaklAddIN.btAddChildClick(Sender: TObject);
begin
//  tbDeti.Append;
//  ActiveControl:=GridDeti;
end;

procedure TfmZAGS_ZaklAddIN.btDelChildClick(Sender: TObject);
begin
...
procedure TfmZAGS_ZaklAddIN.btChoiceChildClick(Sender: TObject);
{
var
  Opis : TOpisEdit;
  v : Variant;
...
//-------------------------------------------------------------------------
procedure TfmZAGS_ZaklAddIN.ReadZRogd(arrRec:TCurrentRecord);
var
  v:Variant;
  s,ss,s2,sRn:String;
  nID,n:Integer;
...
//-------------------------------------------------------------------------
procedure TfmZAGS_ZaklAddIN.TBItemSeekAktClick(Sender: TObject);
var
...
//--------------------------------------------------------------------------
procedure TfmZAGS_ZaklAddIN.TBItemAktRogdClick(Sender: TObject);
var
  Opis : TOpisEdit;
  v : Variant;
  arrRec : TCurrentRecord;
...
procedure TfmZAGS_ZaklAddIN.TBItemAktBrakClick(Sender: TObject);
{
var
  Opis : TOpisEdit;
  v : Variant;
...
procedure TfmZAGS_ZaklAddIN.PostDokument;
begin
  inherited;
end;

procedure TfmZAGS_ZaklAddIN.FormCreate(Sender: TObject);
begin
  inherited;
  {$IFDEF USE_FR3}
...
procedure TfmZAGS_ZaklAddIN.edRukovEditButtons0Click(Sender: TObject;  var Handled: Boolean);
begin
  ChoiceSpecD(edRukov);
end;

procedure TfmZAGS_ZaklAddIN.edNameUpdateData(Sender: TObject;  var Handled: Boolean);
var
  s:String;
begin
...
procedure TfmZAGS_ZaklAddIN.edRNameUpdateData(Sender: TObject; var Handled: Boolean);
var
  s:String;
begin
  FIOUpdateData(Sender,Handled);
...
//----------------------------------------------------------------------
{
function TfmZAGS_ZaklAddIN.GetTypeBrak:Integer;
begin
...
procedure TfmZAGS_ZaklAddIN.edSpecEditButtons0Click(Sender: TObject;  var Handled: Boolean);
begin
  ChoiceSpecD(edSpec);
end;

function TfmZAGS_ZaklAddIN.AddParEnterAdresat(slPar: TStringList;  strFieldName: String): Boolean;
var
  n:Integer;
begin
  Result:=true;
...
procedure TfmZAGS_ZaklAddIN.edD2_DOK_TYPEEditButtons0Click(Sender: TObject; var Handled: Boolean);
begin
  EditDataSet(Dokument);
...
procedure TfmZAGS_ZaklAddIN.edSvid_NomerEditButtons0Click(Sender: TObject;
  var Handled: Boolean);
begin
  EditDataSet(Dokument);
...
procedure TfmZAGS_ZaklAddIN.N_F_cbIsMyClick(Sender: TObject);
begin
