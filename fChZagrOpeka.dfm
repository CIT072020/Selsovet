object fmChZagrOpeka: TfmChZagrOpeka
  Left = 517
  Top = 248
  AutoScroll = False
  Caption = #1047#1072#1075#1088#1091#1079#1082#1072' '#1080#1085#1092#1086#1088#1084#1072#1094#1080#1080
  ClientHeight = 140
  ClientWidth = 333
  Color = clBtnFace
  ...
  object cbCheckData: TDBCheckBoxEh
    ...
    Width = 240
    Height = 17
    Caption = #1047#1072#1075#1088#1091#1079#1082#1072' '#1090#1086#1083#1100#1082#1086' '#1080#1079#1084#1077#1085#1077#1085#1080#1081
    Checked = True
    State = cbChecked
    TabOrder = 6
    ValueChecked = 'True'
