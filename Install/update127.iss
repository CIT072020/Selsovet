...
WizardSmallImageFile=compiler:MY_WIZMODERNSMALLIMAGE.BMP
  ...
  AppVerName=Обновление "ЖКХ" №127
#else
  #ifdef AppZAGS
    AppName=Обновление "ЗАГС"
    AppVerName=Обновление "ЗАГС" №127
  #else
    #ifdef AppOCH
      AppName=Обновление "Учет очередников"
      AppVerName=Обновление "Учет очередников" №127
    #else
      AppName=Обновление ЛАИС
      AppVerName=Обновление ЛАИС №127
    #endif
  #endif
#endif
...
;DiskSpanning=yes
#ifdef AppGKH
  OutputBaseFilename=UpdateGKH127
#else
  #ifdef AppZAGS
    OutputBaseFilename=UpdateZAGS127
  #else
    #ifdef AppOCH
      OutputBaseFilename=UpdateOchered127
    #else
      OutputBaseFilename=UpdateLAIS127
    #endif
  #endif
#endif
...
Source: "E:\Projects\SelSovet7\Doc\РЕГУЛИРОВАНИЕ ЖИЛИЩНЫХ ОТНОШЕНИЙ.doc"; DestDir: "{app}\Doc"; Flags: ignoreversion;
...
#ifdef GISUN
Source: "E:\Projects\SelSovet7\Service\gisun.ini"; DestDir: "{code:GetProgDir}\Service"; Flags: onlyifdoesntexist; Check: IsMainComp
Source: "E:\Projects\SelSovet7\Service\gisun_input.ini"; DestDir: "{code:GetProgDir}\Service"; Flags: ignoreversion; Check: IsMainComp
Source: "E:\Projects\SelSovet7\Service\gisun_output.ini"; DestDir: "{code:GetProgDir}\Service"; Flags: ignoreversion; Check: IsMainComp
#endif
...
root:HKCU;subkey:"Software\VCBOUS\GKH";valuetype:string;valuename:"version";valuedata:"5.3.2"; Flags: uninsdeletevalue
root:HKCU;subkey:"Software\VCBOUS\GKH";valuetype:string;valuename:"update";valuedata:"127"; Flags: uninsdeletevalue
#else
#ifdef AppZAGS
...
root:HKCU;subkey:"Software\VCBOUS\ZAGS";valuetype:string;valuename:"version";valuedata:"5.3.2"; Flags: uninsdeletevalue
root:HKCU;subkey:"Software\VCBOUS\ZAGS";valuetype:string;valuename:"update";valuedata:"127"; Flags: uninsdeletevalue
#else
#ifdef AppOCH
...
root:HKCU;subkey:"Software\VCBOUS\Ochered";valuetype:string;valuename:"version";valuedata:"5.3.2"; Flags: uninsdeletevalue
root:HKCU;subkey:"Software\VCBOUS\Ochered";valuetype:string;valuename:"update";valuedata:"127"; Flags: uninsdeletevalue
#else
...
root:HKCU;subkey:"Software\VCBOUS\LAIS";valuetype:string;valuename:"version";valuedata:"5.3.2"; Flags: uninsdeletevalue
root:HKCU;subkey:"Software\VCBOUS\LAIS";valuetype:string;valuename:"update";valuedata:"127"; Flags: uninsdeletevalue
#endif
#endif
#endif
...
[Run]
Filename: "{app}\UpdateProg.exe"; Parameters:"/LASTUPDATE"; Description: "Сохранить последнее обновление"; WorkingDir: "{app}"; Flags: nowait postinstall skipifsilent
