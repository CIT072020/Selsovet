...
[Files]
Source: "E:\Projects\Selsovet7\ZAH.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: program
#ifdef GISUN
...
Source: "E:\Projects\Selsovet7\splash_zah.bmp"; DestDir: "{app}"; Flags: ignoreversion; Components: program
Source: "E:\Projects\Selsovet7\Update.ico"; DestDir: "{app}"; Flags: ignoreversion; Components: data
...
Source: "E:\Projects\SelSovet7\Doc\Доработки Учет захоронений.doc"; DestDir: "{app}\Doc"; Flags: ignoreversion; Components: program
Source: "E:\Projects\Selsovet7\SysParams.ini"; DestDir: "{app}"; Flags: ignoreversion; Components: program
Source: "E:\Projects\Selsovet7_Data\InstallDataZah\*.*"; DestDir: "{app}\Data"; Flags: ignoreversion uninsneveruninstall; Components: data
...
;Source: "E:\Projects\SelSovet7\Data\ATE.adt"; DestDir: "{app}\NewData"; Flags: ignoreversion; Components: data
;Source: "E:\Projects\SelSovet7\Data\ATE.adi"; DestDir: "{app}\NewData"; Flags: ignoreversion; Components: data
...
Source: "E:\Projects\Selsovet7\Doc\Руководство пользователя Учет захоронений.doc"; DestDir: "{app}\Doc"; Flags: ignoreversion; Components: program
...
Source: "E:\Projects\Selsovet7\Service\*.*"; DestDir: "{app}\Service"; Excludes: "*~.*,*.xml,smdo*.*,fmGurn*.ini,*.pas,OpisFilter*.ini,GISUN*.ini,UserEvents*.ini,Obrabotka*.ini,minsk.pas,personal.pas,*Ochered.*,*ZAGS.*,*OPEKA.*,*OCH.*,*GKH.*,*Post.*,MRUList.ini,Actions.ini,Parameters.tsk,NewParams.tsk,*.bak"; Flags: ignoreversion; Components: program
Source: "E:\Projects\Selsovet7\Service\fmGurnAktZ.ini"; DestDir: "{app}\Service";  Flags: ignoreversion; Components: program
Source: "E:\Projects\Selsovet7\Service\ObrabotkaZAH.ini"; DestDir: "{app}\Service";  Flags: ignoreversion; Components: program
Source: "E:\Projects\Selsovet7\Service\UserEventsZAH.ini"; DestDir: "{app}\Service";  Flags: ignoreversion; Components: program
Source: "E:\Projects\Selsovet7\Service\progz.pas"; DestDir: "{app}\Service";  Flags: ignoreversion; Components: program
...
Source: "E:\Projects\Selsovet7\Work\ParamZAH.loc"; DestDir: "{app}\Work"; Flags: ignoreversion; Components: program
...
#ifdef GISUN
  Name: "{group}\Параметры ГИС РН"; Filename: "{app}\UpdateProg.exe"; Parameters:"/GISUN /ZAH"; WorkingDir: "{app}"; IconFilename: "{app}\Gisun.ico"; Components: data
#endif
...
Name: "{userdesktop}\Учет захоронений"; Filename: "{app}\ZAH.exe"; Tasks: desktopicon; WorkingDir: "{app}"
Name: "{userdesktop}\Документация Учет захоронений"; Filename: "{app}\Doc\Руководство пользователя Учет захоронений.doc"; Tasks: desktopicon; WorkingDir: "{app}"

[Run]
Filename: "{app}\ZAH.exe"; Description: "Учет захоронений"; Flags: nowait postinstall skipifsilent
...
begin
  if CurStep = ssInstall then begin
    ...
    RegWriteStringValue(HKCU, 'Software\VCBOUS\ZAH', 'maincomp', s);
  end;
end;
