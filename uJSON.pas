...
class function TJSONObject.NULL: JNULL;
begin
  result := CNULL;
end;
...
function JNULL.Equals(const Value: TZAbstractObject): Boolean;
begin
  if (value = nil) then begin
    result := true;
  end else begin
    result := (value is JNULL) ;
  end;
end;

function JNULL.toString: string;
begin
  result := 'null';
end;
